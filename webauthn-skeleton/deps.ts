...
import type { ConnInfo } from "https://deno.land/x/opine@2.2.0/deps.ts";
export { opine, json, serveStatic, Router };
export type { HTTPSOptions, HTTPOptions, ConnInfo };
export { WrappedRequest } from "https://deno.land/x/opine@2.2.0/src/request.ts"
