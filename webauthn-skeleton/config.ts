...
config.baseUrl = config.baseUrl?.substring(-1) === "/" ? config.baseUrl?.slice(0,-1) : config.baseUrl;
config.origin = config.origin?.substring(-1) === "/" ? config.origin?.slice(0,-1) : config.origin;
